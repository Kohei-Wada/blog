...
この draft の thinking layer（角度・主張・例・結論）は [私の Obsidian vault](https://github.com/Kohei-Wada/Obsidian) の permanent note に由来します。本記事は surface layer の体裁化のみ AI 介在 ── つまり、ここに示した workflow の最初の検証材料の一つです。
