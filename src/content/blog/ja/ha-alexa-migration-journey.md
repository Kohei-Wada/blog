...
そもそもこの消費電力データを読むには、スマートメーターの **Route-B（B ルート）** に Wi-SUN でつなぐ必要がある。私は RATOC の Wi-SUN USB アダプタ（RS-WSUHA）を使っていて、これが地味にこのセットアップで一番高い部品 ── 2 万円超した。しかも買ってからしばらく塩漬けにしていて、「2 万もするこのちっちゃい USB みたいなやつを遊ばせている」という罪悪感が地味にあった（笑）。この電力レポートで、ようやく元を取り始めた気がしている。
