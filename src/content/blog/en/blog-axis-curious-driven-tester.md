...
- **Zettelkasten's original purpose is output.** Accumulating permanent notes is a _means_ that supports output; making it the goal gets it backwards. The 9-months-4-posts cadence problem reads as "accumulation works, but output has stalled."
