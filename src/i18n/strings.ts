...
const strings = {
  ...
  searchOpenLabel: { ja: '検索を開く (/ または Ctrl+K)', en: 'Open search (press / or Ctrl+K)' },
  menuLabel: { ja: 'メニュー', en: 'Menu' },
  closeSearchLabel: { ja: '検索を閉じる', en: 'Close search' },
  searchResultsLabel: { ja: '検索結果', en: 'Search results' },
  searchTitle: { ja: '記事検索', en: 'Search articles' },
  footerNavLabel: { ja: 'フッター', en: 'Footer' },
  langSwitcherLabel: { ja: '言語切替', en: 'Language' },
  prevPageLabel: { ja: '前のページ', en: 'Previous page' },
  nextPageLabel: { ja: '次のページ', en: 'Next page' },
